      ...
      // if (mysqli_num_rows($stopper)==0) {
        ...
        if (mysqli_num_rows($query)==1) {
         ...
         echo $_SESSION['error'] = "INCORRECT PASSWORD!!!";
          ...
          echo $_SESSION['error'] = "Incorrect Password or Registration number!!!";
        }
      } else {
      ...
      // if (mysqli_num_rows($stopper)==0) {
        ...
        if (mysqli_num_rows($query)==1) {
          ...
          if ($user==$username_a&&$pass==$realpass_a) {
            $_SESSION['username_a']=$first_a .' '. $second_a;
            $_SESSION['reg_a']=$user;
            echo "Loading";
          }else {
         echo $_SESSION['error'] = "INCORRECT PASSWORD!!!";
...
class NexmoMessage {
  ...
  // Done!
                          ...
                          // }else {
                          //     echo "Start with +256 for valid numbers";
                          //   }
                          } else {
  ...
  if (isset($_POST['token'])) {
    ...
    if ($realtoken == '') {
      ...
      if ($realtoken == $snttoken) {
        ...
        $reg = $_SESSION['reg'];
        $pass = $_SESSION['pass'];
        $quer = "SELECT * FROM students WHERE reg_number = '$reg'";
