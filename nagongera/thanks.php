<?php
  ...
  // echo "guild9".$guild9;
  $queryguild = "INSERT INTO guild_n (name, count) VALUES ('$guild', '1')";
  ...
  // echo "rcc9".$rcc9;
  $rcc = $_SESSION['rcc'];
  $queryrcc = "INSERT INTO rcc_n (name, count) VALUES ('$rcc', '1')";
  ...
  // echo "sec9".$sec9;
  $sec = $_SESSION['sec'];
  $querysec = "INSERT INTO sec_n (name, count) VALUES ('$sec', '1')";
  ...
  // echo "spe9".$spe9;
  $spe = $_SESSION['spe'];
  $queryspe = "INSERT INTO spe_n (name, count) VALUES ('$spe', '1')";
  ...
  // echo "male9".$male9;
  $male = $_SESSION['male'];
  $querymale = "INSERT INTO male_n (name, count) VALUES ('$male', '1')";
  ...
  $queryfemale = "INSERT INTO female_n (name, count) VALUES ('$female', '1')";
  ...
  $querychair = "INSERT INTO chair_n (name, count) VALUES ('$chair', '1')";
  $run = mysqli_query($connect, $querychair);
  $name= $_SESSION['reg'];
  $after = "INSERT INTO after_vote_n (reg_number) VALUES ('$name')";
